...
import adoptionHero from "@/assets/aishi/raw/60.png";
import fosterHero from "@/assets/aishi/raw/14.png";
import fosterLifeImage from "@/assets/aishi/raw/17.png";
import fosterSideImage from "@/assets/aishi/raw/WhatsApp Image 2025-11-21 at 11.23.23 PM.jpeg";
import bestFriendLeft from "@/assets/aishi/raw/WhatsApp Image 2025-11-21 at 11.23.22 PM (1).jpeg";
import bestFriendRight from "@/assets/aishi/raw/WhatsApp Image 2025-11-21 at 11.24.37 PM (1).jpeg";
import loveKnowsImage from "@/assets/aishi/raw/WhatsApp Image 2025-11-21 at 11.22.57 PM.jpeg";
...
const RED = "#DB453D";
const btn = (red = false) => ({ display: "inline-flex" as const, alignItems: "center" as const, gap: 8, background: red ? RED : G, color: C, padding: "14px 30px", borderRadius: 10, fontFamily: "'Josefin Sans',sans-serif", fontWeight: 700, fontSize: "0.9rem", letterSpacing: "0.05em", textDecoration: "none", transition: "all 0.2s", boxShadow: red ? "0 4px 16px rgba(219,69,61,0.3)" : "0 4px 16px rgba(1,56,53,0.15)" });
    ...
    <div style={{ backgroundColor: C }}>
      ...
      <section style={{ position: "relative", height: "100svh", minHeight: 500, maxHeight: 740, overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", paddingTop: 72 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
            ...
            <a href="#foster" style={btn(true)}>🏡 Foster a Dog</a>
            <Link href="/donate"><a style={btn(true)}>💛 Virtually Adopt</a></Link>
          </div>
        </div>
      </section>
            ...
            {[{ icon: "🏡", t: "Adopt", d: "Open your heart and home to a rescued dog looking for a family of their own." }, { icon: "🐾", t: "Foster", d: "Provide a temporary home while a dog heals, gains confidence, or waits for their forever family." }, { icon: "💛", t: "Virtual Adoption", d: "Support a dog's food, shelter, and medical care, even if you're unable to bring them home." }].map((w, i) => (
              <div key={i} style={{ background: G, borderRadius: 16, padding: "40px 28px", textAlign: "center", border: "1px solid rgba(241,231,220,0.10)", transition: "all 0.28s", ...s(i+1, r1.visible) }}
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 12 }}>
                  <span style={{ fontSize: "2rem", lineHeight: 1 }}>{w.icon}</span>
                  <h3 style={{ fontFamily: "'Josefin Sans',sans-serif", color: C, fontWeight: 700, margin: 0 }}>{w.t}</h3>
                </div>
      ...
      <section style={{ background: G, padding: "80px 0" }}>
        <div className="container" ref={r2.ref}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr 1fr", gap: 32, alignItems: "center", ...s(0, r2.visible) }}>
            {/* Left photo */}
            <img src={bestFriendLeft} alt="Our dogs" style={{ width: "100%", aspectRatio: "3/4", objectFit: "cover", borderRadius: 16, display: "block" }} />
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <h2 style={{ color: C, fontFamily: "'Josefin Sans',sans-serif", marginBottom: 20 }}>Looking for Your New Best Friend?</h2>
              <p style={{ color: "rgba(241,231,220,0.72)", fontFamily: "'Quicksand',sans-serif", fontSize: "1.05rem", margin: "0 auto 36px", lineHeight: 1.8 }}>
            ...
            {/* Right photo */}
            <img src={bestFriendRight} alt="Our dogs" style={{ width: "100%", aspectRatio: "3/4", objectFit: "cover", borderRadius: 16, display: "block" }} />
          </div>
        </div>
      </section>
        ...
        <div className="container" ref={r5.ref}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 60, alignItems: "center" }}>
            ...
            <div style={{ position: "relative", ...s(1, r5.visible) }}>
              ...
              <img src={loveKnowsImage} alt="Virtual adoption" style={{ width: "100%", aspectRatio: "4/3", objectFit: "cover", borderRadius: 16, display: "block", position: "relative", zIndex: 1 }} />
            </div>
          </div>
        </div>
      </section>
